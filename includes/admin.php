      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="#top" class="active"><?=$info['name']?></a></li>
  ...
  <div id="modal" class="popupContainer" style="display:none;">
    ...
    <section class="popupBody">
        ...
        <div class="social_login">
            ...
            <div id="g_id_onload"
              data-client_id="295882943021-cq6shejjubbn201h9guh65hdpn08ru20.apps.googleusercontent.com"
              data-login_uri="http://localhost/vetpara/login.php"
        ...
        <div class="user_login">
            <form>
                ...
                <div class="checkbox">
                    ...
                    <label for="remember">Lembre-se deste computador</label>
                </div>
      ...
      <div class="row">
       ...
       <!--<div class="col-lg-3">
        ...
        <div class="col-lg-12">
          ...
          <br>Design: <a href="https://templatemo.com/" target="_blank" title="css templates">Grum's Development</a></p>
          </div>
        </div>
      </div>
    </div>
